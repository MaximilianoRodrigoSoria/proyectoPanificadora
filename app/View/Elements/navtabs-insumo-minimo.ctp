<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active" ><?php echo $this->Html->link('Listado de Insumos con Stock por debajo del minimo',array('controller'=>'insumos','action'=>'minimo')); ?></li>
