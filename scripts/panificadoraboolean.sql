...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2017 a las 22:48:52
...
--
-- Base de datos: `panificadoraboolean`
--
...
INSERT INTO `cliente` (`id`, `nombre`, `apellido`, `dni`, `telefono`, `email`, `created`, `modified`, `estado`) VALUES
(2, 'Marcela', 'Lopez', 36410870, 43570264, 'marlo1508@gmail.com', '2017-11-11', '2017-11-12', 1),
(3, 'Juana', 'Oviedo', 35820060, 45559889, 'oviedoJuana_marina@gmail.com', '2017-11-12', '2017-11-12', 1);
...
INSERT INTO `formula` (`id`, `descripcion`, `estado`) VALUES
(1, 'ahrelocoa', 1),
(2, 'sarasa', 1);
...
INSERT INTO `insumos` (`id`, `nombre`, `stock`, `estado`) VALUES
(1, 'Harina 000', 120, 1),
(2, 'harina de salvado', 50, 1);
...
CREATE TABLE `permiso_vista_rol` (
  ...
  `estadi` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `productos` (`id`, `id_formula`, `nombre`, `estado`) VALUES
(3, 1, 'pan_arabe', 1),
(4, 2, 'medialuna_manteca', 1);
...
(13, 'empleado_produccion', 1),
(14, 'administracion', 1),
(15, 'encargado_produccion', 1),
(16, 'gerente_produccion', 1),
(17, 'ventas', 1);
...
INSERT INTO `usuario` (`id`, `rol_id`, `nombre`, `apellido`, `dni`, `telefono`, `email`, `legajo`, `created`, `modified`, `estado`) VALUES
(3, 13, 'Maximiliano', 'Soria', 34080910, 42841996, 'maximiliano@gmail.com', 1, '2017-11-09', '2017-11-12', 1),
(6, 13, 'Yesica', 'Contrera', 35404402, 2147483647, 'yes@gmail.com', 2, '2017-11-09', '2017-11-12', 1),
(7, 14, 'Esteban', 'Slobodianik', 375428, 1167524963, 'steven.arranzkun@gmail.com', 3, '2017-11-12', '2017-11-12', 1),
(8, 13, 'Juan', 'Perez', 32106525, 48983226, 'perezjuan@yahoo.com.ar', 4, '2017-11-12', '2017-11-12', 1),
(10, 14, 'Ruperto', 'Lavalle', 25426942, 420269121, 'lavalle1055@gmail.com', 12, '2017-11-12', '2017-11-12', 1);
